  ...
  useEffect(() => {
    ...
    const fetchStudyData = async () => {
      try {
        ...
        console.log("Study cards from storage:", studyCardsJson);
        if (studyCardsJson) {
          try {
            const selectedCardIds = JSON.parse(studyCardsJson) as string[];
            console.log("Parsed selected card IDs:", selectedCardIds);
            console.log(
              "Total cards before filtering:",
          ...
          console.log("No study cards in sessionStorage, using all cards");
        }
